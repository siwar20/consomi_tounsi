...
import tn.esprit.spring.Oussama.GetAllReclamationResponse;
...
import tn.esprit.spring.service.impl.ReclamationService;
...
public class ReclamationController {
    ...
    ResponseEntity<?> getAllReclamation(){
        ...
        GetAllReclamationResponse reclamations = new GetAllReclamationResponse();
